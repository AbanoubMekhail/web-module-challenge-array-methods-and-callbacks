...
const finals14 = fifaData.filter((arr)=>{
...
console.log('1a',finals14[0]['Home Team Name']);
//(b) Away Team name for 2014 world cup final
console.log('1b',finals14[0]['Away Team Name']);
//(c) Home Team goals for 2014 world cup final
console.log('1c',finals14[0]['Home Team Goals']);
//(d) Away Team goals for 2014 world cup final
console.log('1d',finals14[0]['Away Team Goals']);
//(e) Winner of 2014 world cup final */
console.log('1e',finals14[0]['Win conditions']);
...
console.log('T5', getWinnersByYear(fifaData, getYears, getWinners));
...
function getAverageGoals(data) {
    const averageHomeGolas = data.reduce(function(acc,item){
        return acc + item['Home Team Goals'] + item['Away Team Goals'];
    },0)
    return (averageHomeGolas / data.length).toFixed(2);
 }
